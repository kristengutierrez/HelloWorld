...
set _DeploySetParametersFile=%RootPath%HelloWorldPackageKristenKozmary.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%HelloWorldPackageKristenKozmary.zip" (
echo "%RootPath%HelloWorldPackageKristenKozmary.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%HelloWorldPackageKristenKozmary.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%HelloWorldPackageKristenKozmary.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%HelloWorldPackageKristenKozmary.deploy-readme.txt" (
...
start notepad "%RootPath%HelloWorldPackageKristenKozmary.deploy-readme.txt"
)
echo =========================================================
goto :eof
